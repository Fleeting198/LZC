...
class ProcessRecorder:
    ...
    def __init__(self, processName='DefaultProcess', localDataSet={}, begin=None, total=None, warningMessage='',
                 jsonDir=''):
    ...
    def store_process(self):
        if self.jsonStorage.has_key(self.processName):
            for key, value in self.localDataSet.items():
                self.jsonStorage[self.processName][key] = self.localDataSet[ key]
        else:
